...
/**
 * Test case for class Tx_FrontendUserProfile_Domain_Model_Page.
 *
 * @version $Id$
 ...
 *
 */
class Tx_FrontendUserProfile_Domain_Model_PageTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
	 * @var Tx_FrontendUserProfile_Domain_Model_Page
	 */
	protected $fixture;

	public function setUp() {
		$this->fixture = new Tx_FrontendUserProfile_Domain_Model_Page();
	}
	 ...
	 * @test
	 */
	public function getFormsReturnsInitialValueForObjectStorageContainingTx_FrontendUserProfile_Domain_Model_Form() { 
	 ...
	 * @test
	 */
	public function setFormsForObjectStorageContainingTx_FrontendUserProfile_Domain_Model_FormSetsForms() { 
		$form = new Tx_FrontendUserProfile_Domain_Model_Form();
