...
/**
 * Test case for class Tx_FrontendUserProfile_Domain_Model_Field.
 *
 * @version $Id$
 ...
 *
 */
class Tx_FrontendUserProfile_Domain_Model_FieldTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
	 * @var Tx_FrontendUserProfile_Domain_Model_Field
	 */
	protected $fixture;

	public function setUp() {
		$this->fixture = new Tx_FrontendUserProfile_Domain_Model_Field();
	}
	...
	public function setMinForFloatSetsMin() { 
		$this->fixture->setMin(3.14159265);
	...
	public function setMaxForFloatSetsMax() { 
		$this->fixture->setMax(3.14159265);
